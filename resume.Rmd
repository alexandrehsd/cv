...
positions_sheet_loc <- "https://docs.google.com/spreadsheets/d/1OAgJ0bh1iPgabzCWRKrSsVb7Ny5jLDtdzV27eTfwCT8/" 
# read.table("spreadsheet_url.txt", header=FALSE)$V1
...
cat(
  ...
  <ul>
    ...
    <li>
      ", fa('docker')," <span style='font-size:8.5px;'>Kubernetes and Docker</span>
    </li>
    <li>
